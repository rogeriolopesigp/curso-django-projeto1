...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_invalid_email_error_message(self):
        def callback(form):
            email_field = self.get_by_placeholder(form, 'Type your e-mail here')
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(form, 'Type your username here').send_keys('my_username')
        self.get_by_placeholder(
            form, 'Type your e-mail here').send_keys('email@valid.com')
        self.get_by_placeholder(
            form, 'Type your password here').send_keys('P@ssw0rd1')
        self.get_by_placeholder(
